                        ...
                        <div class="row">
                            <div class="col-xl-4">
                               ...
                               <?php 
                                ...
                                $dosens = mysqli_num_rows($dosen);

                                $ruangan = mysqli_query($conn,"SELECT * FROM ruangan");
                                $r = mysqli_num_rows($ruangan);
                                    ...
                                    <div class="col-md-3">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium">Dosen</p>
                                                        <h4 class="mb-0"><?= $dosens?></h4>
                                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium">Ruangan</p>
                                                        <h4 class="mb-0"><?= $r?></h4>
                                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium">Mahasiswa</p>
